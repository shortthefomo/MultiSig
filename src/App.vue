<template>
    ...
    <footer class="container bg-dark footer position-absolute bottom-0 start-50 translate-middle-x text-center">
        <span class="text-light fancy-font position-absolute bottom-1 start-0 ms-2 mb-4">scan qr code -> </span>
        <button @click="openSign" class="btn btn-default mt-2 mb-4" role="button" id="open-sign">
            <img src="/apple-touch-icon.png" class="p-1 border border-1 rounded-3" alt="open sign" width="60" />
        </button>
    </footer>
</template>
