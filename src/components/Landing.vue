<template>
    <div class="p-2 mb-2 bg-light rounded-3">
        <div class="container-fluid py-3">
            ...
            <p>
                <button v-if="masterKey && signer_lists.length > 0" type="button" class="btn btn-pink mb-2" @click="removeMasterKey" disabled>Remove Master Key</button>
                <button v-else-if="signer_lists.length > 0" type="button" class="btn btn-pink mb-2" @click="restoreMasterKey" disabled>Restore Master Key</button>
