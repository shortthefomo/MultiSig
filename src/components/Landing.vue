<template>
    <div class="p-2 mb-2 bg-light rounded-3">
        ...
        <p> 
            ...
            <button v-if="!hasSignerList" type="button" class="btn btn-green mb-2 me-2 ms-2" data-bs-toggle="modal" data-bs-target="#createSignerList">Create Signer List</button>
            <button v-else-if="hasSignerList" type="button" class="btn btn-green mb-2 me-2 ms-2" data-bs-toggle="modal" data-bs-target="#createSignerList">Edit Signer List</button>
            <button type="button" class="btn btn-purple mb-2 me-2 ms-2" data-bs-toggle="modal" data-bs-target="#assignRegularKey">Assign Regular Key</button>
        </p>
    </div>
    <div class="col-md-12">
...
<script>
    ...
    export default {
        ...
        async mounted() {
            ...
            console.log('this.client', this.client.endpoint)
        },
        computed: {
            masterKeyClass() {
