    ...
    <div class="p-2 mb-2 bg-light rounded-3">
        <div class="container-fluid py-3">
            ...
            <p>
                ...
                <a v-if="signer_lists.length == 0" class="btn btn-green mb-2" @click="createSignerList" role="button" id="remove-master">Create Signer List</a>
                <a v-if="signer_lists.length > 0" class="btn btn-green mb-2" @click="editSignerList" role="button" id="remove-master">Edit Signer List</a>
            </p>
        </div>
    </div>
    <div class="col-md-12">
